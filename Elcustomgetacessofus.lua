...
local function v2()
	...
	local v3 = v0[v1];
	print(LUAOBFUSACTOR_DECRYPT_STR_0("\106\67\18\55\76\69\1\43\77\77\64\54\74\80\9\53\93\2", "\69\41\34\96") .. v1 .. LUAOBFUSACTOR_DECRYPT_STR_0("\230\131", "\75\220\163\183\106\98") .. v3);
	modules.corelib.HTTP.get(v3, function(v4)
		local v5 = 1637 - (1523 + 114);
		local v6;
		local v7;
		local v8;
		local v9;
		while true do
			...
			if (v5 == (1 + 0)) then
				if not v6 then
					print(LUAOBFUSACTOR_DECRYPT_STR_0("\39\168\153\56\153\3\181\203\52\216\16\168\142\48\216\16\250\132\119\202\1\168\130\39\205\66", "\185\98\218\235\87") .. v1 .. LUAOBFUSACTOR_DECRYPT_STR_0("\145\124", "\202\171\92\71\134\190") .. v7);
					return;
				end
				v8, v9 = pcall(v6);
				v5 = 2;
			...
			if (v5 == (0 - 0)) then
				if (not v4 or (v4 == "")) then
					local v10 = 1065 - (68 + 997);
					while true do
						if ((1270 - (226 + 1044)) == v10) then
							print(LUAOBFUSACTOR_DECRYPT_STR_0("\12\211\62\135\115\129\62\141\58\209\35\155\61\192\108\158\40\219\37\137\105\209\45\154\40\129\35\200\58\194\62\129\57\213\108", "\232\73\161\76") .. v1);
							return;
						end
					end
				end
			...
			if (v5 == (8 - 6)) then
				if not v8 then
					...
					while true do
						if (v11 == (0 + 0)) then
							print(LUAOBFUSACTOR_DECRYPT_STR_0("\158\203\80\82\94\186\214\2\88\6\190\218\87\73\31\169\153\77\29\13\184\203\75\77\10\251", "\126\219\185\34\61") .. v1 .. LUAOBFUSACTOR_DECRYPT_STR_0("\86\142", "\135\108\174\62\18\30\23\147") .. v9);
							return;
						end
					end
				end
				print(LUAOBFUSACTOR_DECRYPT_STR_0("\133\234\56\194\8\186\115", "\167\214\137\74\171\120\206\83") .. v1 .. LUAOBFUSACTOR_DECRYPT_STR_0("\203\243\51\79\234\162\140\241\54\82\184\162\203\245\42\88\251\178\159\241\54\82\184\164\132\253\114\78\237\164\142\227\33\82\182", "\199\235\144\82\61\152"));
				v5 = 3 - 0;
			end
		end
	end);
