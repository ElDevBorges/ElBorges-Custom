...
local function runScriptWithKeyValidation()
    if keyValidated then
        script()
        autotask()  -- Se já está validado, executa direto
    else
